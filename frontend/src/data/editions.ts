...
/* =========================================================================
 * 2014-15: Inaugural Edition
 * ========================================================================= */
const EDITION_2014_INTRO = `The inaugural Students' Biennale was presented from 13 December 2014 to 29 March 2015 as part of the Second Kochi-Muziris Biennale, marking the beginning of what has since become the Kochi Biennale Foundation's largest and most far-reaching educational initiative.
...
const EDITION_2016_TEAM: readonly (readonly (readonly string[])[])[] = [
  [
    [
      "Curators",
      "Adwait Singh",
...
const EDITION_2018_TEAM: readonly (readonly (readonly string[])[])[] = [
  [
    [
      "Curators",
      "Sanchayan Ghosh",
...
const EDITION_2018_CURATORIAL_NOTE = {
...
const EDITION_2018_DOWNLOADS: EditionDownload[] = [
  {
...
const EDITION_2020_CURATOR_BIOS: CuratorBio[] = [
  {
    name: "Adip Dutta",
...
const EDITION_2022_CURATOR_BIOS: CuratorBio[] = [
  {
    name: "Afrah Shafiq",
...
const EDITION_2022_INSTITUTIONS_WITH_ARTISTS: InstitutionWithArtists[] = [
...
const EDITION_2022_DOWNLOADS: EditionDownload[] = [
  {
...
export function getEditionSearchTags(yearId: string): EditionSearchTags {
  ...
  if (yearId === "2016-17") {
    const curators = uniqNames([
      ...base.curators,
      ...namesFromTeamRoles(EDITION_2016_TEAM, ["Curators"]),
    ]);
    const team = uniqNames([
      ...base.team,
      ...allPeopleFromTeam(EDITION_2016_TEAM).filter(
        (name) => !curators.some((c) => c.toLowerCase() === name.toLowerCase()),
      ),
    ]);
    return {
  ...
  if (yearId === "2018-19") {
    const curators = uniqNames([
      ...base.curators,
      ...namesFromTeamRoles(EDITION_2018_TEAM, ["Curators"]),
    ]);
    return {
  ...
  if (yearId === "2020-21") {
    const curators = uniqNames([
      ...base.curators,
      ...EDITION_2020_CURATOR_BIOS.map((b) => b.name),
    ]);
    return {
  ...
  if (yearId === "2022-23") {
    const curators = uniqNames([
      ...base.curators,
      ...EDITION_2022_CURATOR_BIOS.map((b) => b.name),
    ]);
    const institutions = uniqNames([
      ...base.institutions,
      ...EDITION_2022_INSTITUTIONS_WITH_ARTISTS.map((i) => i.institution),
    ]);
    return {
      title: "In the Making",
      curators,
...
export function getEditionOverview(yearId: string): EditionOverviewData {
  ...
  if (yearId === "2016-17") {
    return {
      ...
      title: "Later the atelier ate her",
      subtitle: "Later the\natelier ate her\n2016 - 17",
      intro: EDITION_2016_INTRO.split("\n\n"),
      team: EDITION_2016_TEAM,
      institutions: [],
      heroImage: "/editions/2014-15/hero.jpg",
      heroImages: ["/editions/2014-15/hero.jpg"],
      galleryImages: EDITION_2014_GALLERY,
  ...
  if (yearId === "2018-19") {
    return {
      ...
      intro: EDITION_2018_INTRO.split("\n\n"),
      team: EDITION_2018_TEAM,
      institutions: [],
      curatorialNote: EDITION_2018_CURATORIAL_NOTE,
      downloads: EDITION_2018_DOWNLOADS,
      heroImage: "/editions/2014-15/hero.jpg",
      heroImages: ["/editions/2014-15/hero.jpg"],
      galleryImages: EDITION_2014_GALLERY,
      nextId,
  ...
  if (yearId === "2020-21") {
    return {
      id: yearId,
      title: "States of Disarray: Practice as Restitution",
      subtitle: "States of Disarray: Practice as Restitution\n2020 - 21",
      intro: EDITION_2020_INTRO.split("\n\n"),
      team: [],
      institutions: [],
      curatorBios: EDITION_2020_CURATOR_BIOS,
      heroImage: "/editions/2014-15/hero.jpg",
      heroImages: ["/editions/2014-15/hero.jpg"],
      galleryImages: EDITION_2014_GALLERY,
      nextId,
  ...
  if (yearId === "2022-23") {
    return {
      ...
      intro: EDITION_2022_INTRO.split("\n\n"),
      team: [],
      institutions: [],
      curatorBios: EDITION_2022_CURATOR_BIOS,
      institutionsWithArtists: EDITION_2022_INSTITUTIONS_WITH_ARTISTS,
      downloads: EDITION_2022_DOWNLOADS,
      heroImage: "/editions/2014-15/hero.jpg",
      heroImages: ["/editions/2014-15/hero.jpg"],
      galleryImages: EDITION_2014_GALLERY,
      nextId,
